...
const PATHS = {
  ...
  settings: 'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 13.5l1.6 1.2-2 3.5-1.9-.7a7.5 7.5 0 0 1-2.1 1.2L14.7 21h-4l-.3-2.3a7.5 7.5 0 0 1-2.1-1.2l-1.9.7-2-3.5 1.6-1.2a7.6 7.6 0 0 1 0-2.4L4.4 9.9l2-3.5 1.9.7a7.5 7.5 0 0 1 2.1-1.2L10.7 3.6h4l.3 2.3a7.5 7.5 0 0 1 2.1 1.2l1.9-.7 2 3.5-1.6 1.2a7.6 7.6 0 0 1 0 2.4z',
} as const;
